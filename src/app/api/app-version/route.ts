...
const FALLBACK: Record<string, AppVersionPayload> = {
  staff: {
    ...
    changelog_ar: 'واجهة المحركات + welcome wizard + Today strip + POS confirmation + offline banner + تفضيلات التنبيهات + إصلاحات الاشتراك + 8 تحسينات polish (labels، plan urgency، geofence map، RTL، WhatsApp counter، preload steps)',
    changelog_en: null,
    force: false,
  },
  iot: {
